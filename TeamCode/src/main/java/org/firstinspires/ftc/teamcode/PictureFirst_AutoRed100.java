...
//              squaresOverlay.findViewById(R.id.firstBeacon).setVisibility(View.VISIBLE);
        ...
        //If they match and say blue is on the right, go for the right
            ...
            if(opModeIsActive()) robotBase.turn(285 - adjustmentAngle +(float)correctionAngle);
            try {
                if(opModeIsActive()) robotBase.pushButton(285 - adjustmentAngle + (int)correctionAngle, 290 - adjustmentAngle, 2);
            }
            catch (TimeoutException e) {
